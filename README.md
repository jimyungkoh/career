...
| 문서 | 원천 (SoT) | HTML | PDF |
| --- | --- | --- | --- |
| 이력서 | [resume.md](content/resume.md) | [resume.html](output/resume.html) | [resume.pdf](output/resume.pdf) |
| 경력기술서 | [work-experience.md](content/work-experience.md) | [work-experience.html](output/work-experience.html) | [work-experience.pdf](output/work-experience.pdf) |
...
인쇄 값이 바뀌면 같은 작업에서 대응 PDF도 재생성한다. PDF도 파생 산출물이므로 직접 편집하지 않는다. 자세한 절차는 [PDF 문서 규격](docs/pdf-spec.md)을 따른다.

## 규칙

- 에이전트 작업 규칙: [AGENTS.md](AGENTS.md)
- HTML 문서 규격: [docs/html-spec.md](docs/html-spec.md)
- PDF 문서 규격: [docs/pdf-spec.md](docs/pdf-spec.md)
